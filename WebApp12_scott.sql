...
INSERT INTO TBL_MEMBER(SID, NAME, TEL) VALUES(MEMBERSEQ.NEXTVAL, '김소연', '010-1111-1111');
INSERT INTO TBL_MEMBER(SID, NAME, TEL) VALUES(MEMBERSEQ.NEXTVAL, '정미화', '010-22222-2222');
INSERT INTO TBL_MEMBER(SID, NAME, TEL) VALUES(MEMBERSEQ.NEXTVAL, '이찬호', '010-3333-3333');
INSERT INTO TBL_MEMBER(SID, NAME, TEL) VALUES(MEMBERSEQ.NEXTVAL, '장진하', '010-4444-4444');
INSERT INTO TBL_MEMBER(SID, NAME, TEL) VALUES(MEMBERSEQ.NEXTVAL, '이다영', '010-5555-5555');
--==>> 1 행 이(가) 삽입되었습니다. * 5
...
--○ 회원 정보 수정
UPDATE TBL_MEMBER
SET NAME='손다정', TEL='010-1100-1100'
WHERE SID=1;

--> 한 줄 구성
UPDATE TBL_MEMBER SET NAME='손다정', TEL='010-1100-1100' WHERE SID=1
;
--==>> 1 행 이(가) 업데이트되었습니다.
...
--==>>
/*
1	김소연	010-1111-1111	91	81	71
2	정미화	010-22222-2222	80	70	60
*/ 
...
--==>>
/*
1	김소연	90	80	70	240	80	1
2	정미화	80	70	60	210	70	2
3	이찬호	-1	-1	-1	-3	-1	3
4	장진하	-1	-1	-1	-3	-1	3
5	이다영	-1	-1	-1	-3	-1	3
*/
...
--> 한줄구성
SELECT SID, NAME, KOR, ENG, MAT, (KOR+ENG+MAT) AS TOT, ((KOR+ENG+MAT)/3) AS AVG, RANK() OVER(ORDER BY (KOR+ENG+MAT) DESC) AS RANK FROM VIEW_MEMBERSCORE WHERE SID=1
;
--==>> 1	김소연	90	80	70


--○ 참조 데이터 레코드 수 확인
--> SID 1을 사용하는 회원의 점수가 등록되어 있는지 여부 확인
--> 자식 데이터가 있으므로 회원 정보를 삭제할 수 없음.
SELECT COUNT(*) AS COUNT
FROM TBL_MEMBERSCORE
WHERE SID=1;
--> 한 줄 구성
